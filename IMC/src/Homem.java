...
public class Homem extends PessoaIMC {
    ...
    public void parametrosIMC(){
        System.out.println("Para homens: \n");
        System.out.println("IMC maior que 26,4                   - Acima do peso ideal!\n");
        System.out.println("IMC menor que 26,4 e maior que 20,7  - Peso ideal!\n");
        System.out.println("IMC menor ou igual a 20,7            - Abaixo do peso ideal!\n ");
        System.out.println("-----------------------------------------\n");
    }
}