...
public class Mulher extends PessoaIMC {
    ...
    public void parametrosIMC(){
        System.out.println("Para mulheres: \n");
        System.out.println("IMC maior que 25,8                 - Acima do peso ideal!\n");
        System.out.println("IMC menor que 25,8 e maior que 19  - Peso ideal!\n");
        System.out.println("IMC menor ou igual a 19            - Abaixo do peso ideal!\n ");
        System.out.println("-----------------------------------------\n");
    }
}
